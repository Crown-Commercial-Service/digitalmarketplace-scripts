...
Usage:
    scripts/oneoff/generategenerate-g-cloud-8-master-csv.py <data_api_stage> <data_api_token>

Example:
    scripts/oneoff/generategenerate-g-cloud-8-master-csv.py preview myToken
"""
import csv
...
if __name__ == "__main__":
    ...
    generate_g8_master_csv(
        data_api_url=get_api_endpoint_from_stage(arguments['<data_api_stage>']),
