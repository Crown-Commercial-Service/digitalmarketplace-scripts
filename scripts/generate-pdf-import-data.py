...
<document_type> can be either: result_letter or framework_agreement
<input_file> should be a path to the successful.csv file generated by scripts/export-dos-suppliers.py
